...
class _InfoState extends State<Info> with TickerProviderStateMixin {
        ...
        child: new Center(
          child: new ListView(
            ...
            children: <Widget>[
              ...
              _getContentSecond("Developer","Bits Jr - Soluções em TI","https://bitsjr.com.br/"),
  ...
  Widget _getTittle() {
    return Center(
      child: new Text("CONECTA REDE",
        style: new TextStyle(
            fontWeight: FontWeight.bold,
            color: Color.fromARGB(255, 245, 75, 100),
            fontSize: 25.0),
      ),
    );
  }
      ...
      child: new Column(
        children: <Widget>[
          ...
          new GestureDetector(
            child: new Text(
              tittleLink,
              style: new TextStyle(color: Color.fromARGB(255, 245, 75, 100)),
            ),
            onTap: (){
              _launchURL(link);
            },
